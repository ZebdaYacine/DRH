...
<html>
    ...
    <body class="rtl jumbotron">
        ...
        $t = $t2 = "";
        $sql3 = "select*from empolyer where id_emp=" . $id . "";
        ...
        if ($_SESSION['view_gener'] == "masqlin") {
            $t = "checked=true";
        } else {
            $t1 = "checked=true";
        }
                            ...
                            <form method="post" enctype="multipart/form-data" action="ins.php">
                                ...
                                <div class="form-row ">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" value="<?php echo $_SESSION['view_code']; ?>" class="form-control  mt-3" name="code" id="code" placeholder="الرقم السري">
                                ...
                                <div class="">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label mr-3 ml-2" >
                                            انثى
                                        </label>
                                ...
                                <div class="row justify-content-strat">
                                    <div class="form-group col-4 ">
                                        ...
                                        <select disabled="true" class="form-control" id="place_travialle" name="place_travialle">
                                            <option><?php  echo get_from_table("nom_facl", "faculter", "id_facl", $_SESSION['view_facl']); ?></option>
                                            <?php
                                            $sql = "select*from faculter where id_facl !=" . $_SESSION['view_facl'];
                                    ...
                                    <div class="form-group  col-4 ">
                                        <lable>قسم</lable>
                                        <select class="form-control" disabled="true" id="place_travialle1" name="place_travialle1">
                                            <option><?php echo get_from_table("nom_dept", "departement", "id_dept", $a); ?></option>
                                            <?php
                                            $sql = "select*from departement where   id_dept!=" . $_SESSION['view_dept'];
                                            $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo'<option>' . $row['nom_dept'] . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group col-4 ">
                                        ...
                                        <select class="form-control" disabled="true" name="grade" id="grade">
                                            <option><?php echo get_from_table("nom_grade", "grade", "id_grade", $_SESSION['view_grade']); ?></option>
                                            <?php
                                ...
                                <div class="form-row ">
                                    <div class="form-group col-3">
                                        ...
                                        <input type="date" disabled="true" value="<?php echo $_SESSION['view_date_rect']; ?>" name="date_rect" id="date_rect" class="form-control " style="height: 35px;border-radius:5px;">
                                        <span class="alert-danger"><?php echo $_SESSION['date1rErr'] ?></span>
                                    </div>
                                    <div class="form-group col-3">
                                        <label>شهادة</label>
                                        <select class="form-control" name="deplome" disabled="true" id="deplome">
                                            <option><?php echo get_from_table("nom_deplome", "Deplome", "id_deplome", $_SESSION['view_deplome']); ?></option>
                                            <?php
                                            $d = $_SESSION['view_deplome'];
                                            $sql = "select*from Deplome where id_deplome!=$d";
                                            $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo'<option>' . $row['nom_deplome'] . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group  col-3">
                                        ...
                                        <input type="text" name="note" disabled="true" value="<?php echo $_SESSION['view_note']; ?>"  id="note" class="form-control " style="height: 35px;border-radius:5px;">
                                        <span class="alert-danger"><?php echo $_SESSION['noterErr'] ?></span>
                                    </div>
                                    <div class="form-group col-3">
                                        <label>الصلاحية</label>
                                        <select class="form-control" id="droit" disabled="true" name="droit">
                                            <option><?php echo get_from_table("droit", "role", "id_role", $_SESSION['view_role']) ?></option>
                                            <?php
