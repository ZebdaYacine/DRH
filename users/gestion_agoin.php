...
<html>
    ...
    <body class="rtl jumbotron">
        ...
        if ($_SESSION['idr'] != 4) {
            ...
            $titel = "الاعوان المسجلين";
            $_SESSION['mod'] = "اضافة عون";
            $_SESSION['href'] = "insert_admin.php";
        ?>
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="gestion_agoin.php">الاعوان</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <a href="insert_admin.php?type=agoin"><i class="fas fa-plus-circle fa-1x " style="color: #17a2b8">&nbsp&nbsp <?php echo $_SESSION['mod'] ?></i></a>
